...
public class Cart {
    ...
    // 2. THAY ĐỔI LÕI: Dùng ObservableList thay vì ArrayList
    private ObservableList<Media> itemsOrdered = FXCollections.observableArrayList();

    // 3. THÊM GETTER: Bắt buộc phải có để CartController gọi và lấy dữ liệu đổ vào bảng
	...
	public void sortByTitle() {
        FXCollections.sort(itemsOrdered, COMPARE_BY_TITLE_COST);
        System.out.println("Giỏ hàng đã được sắp xếp theo tiêu đề.");
    }

    public void sortByCost() {
        FXCollections.sort(itemsOrdered, COMPARE_BY_COST_TITLE);
